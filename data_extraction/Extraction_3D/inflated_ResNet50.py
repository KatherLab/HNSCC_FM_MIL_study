#Adapted from https://github.com/hassony2/inflated_convnets_pytorch/blob/master/
import math
import torch
import inflate
import copy
import torch
import torchvision
def run_inflater(ResNet_dim:int):
...
class I3ResNet(torch.nn.Module):
    def __init__(self, resnet2d, frame_nb=16, class_nb=1000, conv_class=True):
        """
        Args:
